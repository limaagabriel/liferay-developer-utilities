...
-   **Development Sessions**: The "bread and butter" of `lp`. It uses `tmux` to orchestrate a unified development environment (bundle logs, git, and workspace shell) in a single terminal.
